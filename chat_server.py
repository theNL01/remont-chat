...
2. Клиент назвал имя → поздоровайся по имени, ответь на вопрос и уточни детали: что именно нужно сделать, какая площадь, в каком состоянии объект, когда планируют начать
