...
2. Сколько комнат в объекте (для веранды не спрашивай). Если объект - дом или дача, также спроси сколько этажей.
...
7. Какие работы нужны в каждом помещении - перечисли варианты через запятую чтобы клиенту было проще выбрать: демонтаж, стяжка пола, стены и потолки, укладка плитки, укладка ламината/паркета, электрика, сантехника, установка дверей, покраска, поклейка обоев, натяжной потолок, тёплый пол. Клиент может выбрать несколько.
